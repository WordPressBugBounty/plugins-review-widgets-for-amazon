...
$chosedPlatform = new $className($forcePlatform, $filePath, "do-not-care-13.3.2", "do-not-care-Widgets for Amazon Reviews", "do-not-care-Amazon");
...
return self::get_alertbox($type, '<strong>'.$title.'</strong><br />'.$text.'<br /><i style="opacity: 0.65">('. sprintf(__('This message is not be visible to visitors in public mode.') .')</i>', 'review-widgets-for-amazon'), false);
}
...
return $this->frontEndErrorForAdmins(__('Free plugin features are unavailable with AMP plugin.', 'review-widgets-for-amazon'));
}
...
if (!$reviews) {
return self::get_alertbox('error', __('You do not have reviews with the current filters. <br />Change your filters if you would like to display reviews on your page!', 'review-widgets-for-amazon'));
}
