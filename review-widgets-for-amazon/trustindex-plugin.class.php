...
return '<a class="ti-btn" href="https://lp.trustindex.io/'.$this->getShortName().'-wp/?a=sys&c='. $campaignId .'" target="_blank">'. __('Create a Free Account for More Features', 'review-widgets-for-amazon') .'</a>';
}
...
$chosedPlatform = new $className($forcePlatform, $filePath, "do-not-care-13.2.7", "do-not-care-Widgets for Amazon Reviews", "do-not-care-Amazon");
...
return self::get_alertbox('error', ' @ <strong>'. __('Trustindex plugin', 'review-widgets-for-amazon') .'</strong> <i style="opacity: 0.65">('. __('This message is not be visible to visitors in public mode.', 'review-widgets-for-amazon') .')</i><br /><br />'. $text, false);
}
