...
<?php echo esc_html(__('Example Widget', 'review-widgets-for-amazon')); ?>:
...
<div class="preview"><?php echo wp_kses($pluginManagerInstance->renderWidgetFrontend('8ad9c2441bbd854e742cecbbe', true), $pluginManager::$allowedAttributesForWidget); ?></div>
</div>
</div>
</div>
<?php
