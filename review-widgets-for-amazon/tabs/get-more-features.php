...
<p class="ti-bold">
<?php
/* translators: %s: user number (1,000,000) */
echo esc_html(sprintf(__('%s+ WordPress websites use Trustindex to embed reviews fast and easily.', 'review-widgets-for-amazon'), '1,000,000'));
?><br />
