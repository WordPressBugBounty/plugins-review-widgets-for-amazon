...
$stepList = [
sprintf(__('Connect %s', 'trustindex-plugin'), 'Amazon'),
...
$labelText = sprintf(__('%s Business URL', 'trustindex-plugin'), 'Amazon');
$infoText = __("Type your business/company's URL and select from the list", 'trustindex-plugin');
$errorText = sprintf(__('Please add your URL again: this is not a valid %s page.', 'trustindex-plugin'), "Amazon");
...
$errorText = sprintf(__('Please add your URL again: this is not a valid %s page.', 'trustindex-plugin'), __('Amazon Seller Profile', 'trustindex-plugin'));
...
<?php endif; ?>
<h1 class="ti-header-title ti-mt-2"><?php echo sprintf(__('Check some %s widget layouts and styles', 'trustindex-plugin'), 'Amazon reviews'); ?></h1>
...
<p>
<?php echo sprintf(__('There are no reviews on your %s platform.', 'trustindex-plugin'), 'Amazon'); ?>
</p>
</div>
<?php endif; ?>
