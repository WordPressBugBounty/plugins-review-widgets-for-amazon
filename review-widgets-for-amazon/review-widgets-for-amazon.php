...
$trustindex_pm_amazon = new TrustindexPlugin_amazon("amazon", __FILE__, "12.7.5", "Widgets for Amazon Reviews", "Amazon");
...
<p>
<a href="<?php echo admin_url("admin.php?page=review-widgets-for-amazon/settings.php&wc_notification=open"); ?>" target="_blank" class="trustindex-rateus" style="text-decoration: none">
<button class="button button-primary"><?php echo __('Download plugin', 'trustindex-plugin'); ?></button>
</a>
<a href="<?php echo admin_url("admin.php?page=review-widgets-for-amazon/settings.php&wc_notification=hide"); ?>" class="trustindex-rateus" style="text-decoration: none">
